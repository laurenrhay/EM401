...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_2/M00_ARESETN] [get_bd_pins axi_interconnect_2/S00_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_2/ACLK] [get_bd_pins axi_interconnect_2/M00_ACLK] [get_bd_pins axi_interconnect_2/S00_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK]
...
#  -string -flagsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 1 -y -310 -defaultsOSRD
preplace inst axi_dma_1 -pg 1 -lvl 3 -y -310 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 5 -y -290 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 1 -y -600 -defaultsOSRD
preplace inst axi_interconnect_1 -pg 1 -lvl 4 -y -570 -defaultsOSRD
preplace inst axi_interconnect_2 -pg 1 -lvl 4 -y -310 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 2 -y -300 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y -510 -defaultsOSRD
preplace netloc axi_dma_1_M_AXI_S2MM 1 3 1 910
preplace netloc processing_system7_0_M_AXI_GP0 1 0 6 -80 -750 NJ -750 NJ -750 NJ -750 NJ -750 1620
preplace netloc processing_system7_0_FCLK_RESET0_N 1 4 2 1220 -380 1620
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 0 6 -100 -760 NJ -760 NJ -760 920 -760 NJ -760 1640
preplace netloc axi_dma_0_M_AXI_MM2S 1 1 3 260 -630 NJ -630 NJ
preplace netloc axi_interconnect_0_M00_AXI 1 0 2 -90 -740 250
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 0 6 -70 -190 280 -190 580 -190 940 -190 NJ -190 1620
preplace netloc axis_data_fifo_0_M_AXIS 1 2 1 N
preplace netloc axi_interconnect_0_M01_AXI 1 1 2 NJ -590 580
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 -80 -450 270 -450 590 -450 930 -450 1210 -400 1630
preplace netloc axi_dma_0_M_AXIS_MM2S 1 1 1 N
preplace netloc axi_interconnect_2_M00_AXI 1 4 1 1200
preplace netloc axi_interconnect_1_M00_AXI 1 4 1 1200
levelinfo -pg 1 -120 90 430 750 1070 1420 2540 -top -770 -bot 170
",
}
